            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-xl-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle mb-2 text-muted">@lang('home.restaurants.information.location')</h6>
                        <p class="card-text">{{ $restaurant->location }}</p>

                        <h6 class="card-subtitle mb-2 text-muted">@lang('home.restaurants.information.opening-hours')</h6>
